---
title: Chaque image (balise ``<img>`` ou balise possédant l’attribut WAI-ARIA `role="img"`) [porteuse d’information](#g-image-porteuse-d-information) a-t-elle une [alternative textuelle](#g-alternative-textuelle-image) ?
---
